...
const ProductDisplay = () => {
  ...
  return (
    <div className="flex flex-col p-6 bg-gray-900 border-none outline-0 mt-[-30px] mx-6 h-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full">
        ...
        {[...Array(6)].map((_, index) => (
          <div
            key={index}
            className="w-full min-w-[250px] max-w-[400px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between"
            style={{
          ...
          >
            ...
            <div className="flex flex-col items-center pb-1">
              ...
              <div className="flex w-full md:mt-6 gap-2 mt-auto">
                ...
                >
                  <img className="w-5 h-5" src={Youtube} alt="" /> 5 Videos
                </a>
              </div>
            </div>
          </div>
