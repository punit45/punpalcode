...
const App = () => {
  ...
  const Menus = [
    ...
    { title: "Calender ", src: "calendar-days" },
  ...
  return (
    <div className="flex">
      <div className={` ${open ? "w-72" : "w-20 "} bg-gray-800 border-none rounded-2xl h-screen p-5  pt-8 relative duration-300`}>
        <img
          src="./src/assets/chevron-left.png"
          className={`absolute cursor-pointer -right-3 top-9 w-7 border-gray-800 bg-gray-500
        ...
        <ul className="pt-6">
          {Menus.map((Menu, index) => (
            <li
              ...
              ${Menu.gap ? "mt-9" : "mt-2"} ${index === 0 && "bg-light-white text-gray-300"
                } `}
            >
